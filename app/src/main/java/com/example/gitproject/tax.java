...
public class tax {
    ...
    // Tax 19/20
    private static final int MAX_PERSONAL_ALLOWANCE = 1250000;
    private static final int PERSONAL_ALLOWANCE_THRESHOLD = 20000000;

    private static final int TAX_BASIC_RATE_THRESHOLD = 3750000;
    private static final int TAX_HIGHER_RATE_THRESHOLD = 15000000;
    ...
    private static final int LEL_NI = 603600;
    private static final int PT_NI = 842400;
    private static final int ST_NI = 842400;
    private static final int UAP_NI = 4635600;
    private static final int UEL_NI = 4635600;
    private static final int UST_NI = 4635600;

    private static final double LOWER_RATE_NI = 0.02;
    private static final double MIDDLE_RATE_NI = 0.0585;
    private static final double UPPER_RATE_NI = 0.106;
    private static final double TOP_RATE_NI = 0.12;
    ...
    public int calculateTotalTaxDeductions() {
        ...
        if ( grossIncome <= assessedBasicRateThreshold ) {
            ...
            basicRateDeduction = (int) (TAX_BASIC_RATE * (assessedBasicRateThreshold - personalAllowance));
        }
